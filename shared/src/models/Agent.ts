...
export type AgentRunOutcome = 'succeeded' | 'failed' | 'canceled' | 'interrupted';
...
export interface Agent {
  ...
  queuePaused?: boolean;
  pendingIntegrationCleanup?: boolean;
  logs?: AgentLogEntry[];
  lastActivity: number;
  createdAt: number;
  costUsd?: number;
  ...
  codeSnapshots?: Array<{ beforeTurnIndex: number; commit: string; ref?: string }>;
